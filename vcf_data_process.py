...
data_dir = "/home/xwm/DeepSVFilter/datasets/NA12878_PacBio_MtSinai/pbsv/"
filename = data_dir + "ref.chr1.var.vcf"
...
for index, row in delete_result_data.iterrows():
    ...
    if("END" in s):
        ...
        s = s.split(";")[0]
        s = int(s)
        insert_result_data.loc[index, ["END"]] = insert_result_data.loc[index, ["POS"]] + s
